...
ERROR_LOG = ERROR_DIR / "ml_nhl_errors.txt"
SUMMARY_LOG = ERROR_DIR / "ml_nhl_summary.txt"
...
def process_nhl_files():
    ...
    for file_path in files:
        try:
            ...
            df["away_ml_acceptable_decimal_odds"] = (df["away_ml_fair_decimal_odds"] * (1 + EDGE_NHL)).round(2)
            ...
            df["home_ml_acceptable_decimal_odds"] = (df["home_ml_fair_decimal_odds"] * (1 + EDGE_NHL)).round(2)
