...
ERROR_LOG = ERROR_DIR / "ml_nba_errors.txt"
SUMMARY_LOG = ERROR_DIR / "ml_nba_summary.txt"
...
def process_nba_files():
    ...
    for file_path in files:
        try:
            ...
            df["away_ml_acceptable_decimal_odds"] = (df["away_ml_fair_decimal_odds"] * (1 + EDGE_NBA)).round(2)
            ...
            df["home_ml_acceptable_decimal_odds"] = (df["home_ml_fair_decimal_odds"] * (1 + EDGE_NBA)).round(2)
