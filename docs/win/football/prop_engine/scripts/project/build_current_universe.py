...
REQUIRED READS:
    ...
    docs/win/football/prop_engine/data/current/source/roster_weekly_{season}.parquet

SUPPORTING READ:
    docs/win/football/nfl/data/master/team_master.csv

OPTIONAL READ (for the defensive-role OR clause):
    docs/win/football/prop_engine/data/current/source/snap_counts_{season}.parquet

WRITES:
    docs/win/football/prop_engine/data/current/{season}_week_{week}_universe.parquet
    docs/win/football/prop_engine/logs/current_universe_{season}_week_{week}.json
