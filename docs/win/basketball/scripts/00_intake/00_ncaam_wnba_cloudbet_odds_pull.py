...
OUTPUT_DIR = Path("docs/win/basketball/odds")
...
def write_grouped_files(league_key: str, output_label: str, rows: list) -> list:
    ...
    try:
        for league_key, cfg in LEAGUES.items():
            ...
            try:
                ...
                files_written.extend(write_grouped_files(league_key, output_label, parsed_rows))
