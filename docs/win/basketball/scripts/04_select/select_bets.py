            ...
            # =========================
                ...
                for side in ["home", "away"]:
                    ...
                    if league == "NBA":
                        ...
                        if side == "home":
                            if edge >= 0.09 and spread_abs <= 7.5:
                                new_row = row.copy()
                            ...
                            if edge >= 0.08 and spread_abs <= 7.5:
                                new_row = row.copy()
                                new_row["market_type"] = "spread"
                                new_row["bet_side"] = side
                                new_row["line"] = spread_val
