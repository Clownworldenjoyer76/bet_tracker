        ...
        for _, row in df.iterrows():
            ...
            # =========================
                ...
                for side in ["home", "away"]:
                    ...
                    if league == "NBA":
                        if edge >= 0.06 and spread_abs <= 10.5:
                            new_row = row.copy()
