...
for RUN_DATE in RUN_DATES:
    ...
    for (
        ...
        try:
            ...
            moneyline_vals = nhl.loc[nhl.market_type == "moneyline", "Win_Pct"].values
            puck_line_vals = nhl.loc[nhl.market_type == "puck_line", "Win_Pct"].values
            total_vals = nhl.loc[nhl.market_type == "total", "Win_Pct"].values
...
df["NHL_PUCK_LINE_WIN_PCT_SORT"] = pd.to_numeric(df["NHL_PUCK_LINE_WIN_PCT"], errors="coerce")
df["NHL_TOTAL_WIN_PCT_SORT"] = pd.to_numeric(df["NHL_TOTAL_WIN_PCT"], errors="coerce")

df = df.sort_values(
    ["NHL_PUCK_LINE_WIN_PCT_SORT", "NHL_TOTAL_WIN_PCT_SORT"],
    ascending=[False, False]
).drop(columns=["NHL_PUCK_LINE_WIN_PCT_SORT", "NHL_TOTAL_WIN_PCT_SORT"])
