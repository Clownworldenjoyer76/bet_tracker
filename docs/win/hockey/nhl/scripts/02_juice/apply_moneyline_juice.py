#!/usr/bin/env python3
# hockey/nhl/scripts/02_juice/apply_moneyline_juice.py
...
def main() -> None:
    ...
    try:
        wipe_market_outputs(
            OUTPUT_DIR,
            ERROR_DIR,
            output_glob="*moneyline*.csv",
            quarantine_glob="*moneyline*_quarantine.csv",
            label="moneyline",
            log=log,
        )
        ...
        print(
            "apply_moneyline_juice complete."
        )
